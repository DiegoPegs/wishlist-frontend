          ...
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-gray-600 mt-1">
                {wishlistsLoading
                  ? 'Carregando...'
                  : `${wishlists?.length || 0} ${(wishlists?.length || 0) === 1 ? 'lista' : 'listas'} encontrada${
                      (wishlists?.length || 0) === 1 ? '' : 's'
                    }`}
              </p>
            </div>
            <Link href="/dashboard/new">
              <Button variant="ghost">+ Nova Lista</Button>
            </Link>
          </div>
            ...
            <div>
              ...
              <p className="text-gray-600 mt-1">
                {dependentsLoading
                  ? 'Carregando...'
                  : `${dependents?.length || 0} ${
                      (dependents?.length || 0) === 1 ? 'dependente' : 'dependentes'
                    } cadastrado${(dependents?.length || 0) === 1 ? '' : 's'}`}
              </p>
            </div>
            <Button
